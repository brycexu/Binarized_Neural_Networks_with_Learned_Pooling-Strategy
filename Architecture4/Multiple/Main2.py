...
trainset = torchvision.datasets.CIFAR10(root='/home/AN96120/brycexu/CIFAR10', train=True, download=False, transform=transform_train)
...
testset = torchvision.datasets.CIFAR10(root='/home/AN96120/brycexu/CIFAR10', train=False, download=False, transform=transform_test)
...
optimizer1 = torch.optim.SGD(model.parameters(), lr=0.05, momentum=0.9)
