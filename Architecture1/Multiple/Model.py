...
class MutipleBNN(nn.Module):
    def __init__(self):
        ...
        self.convolutions = nn.Sequential(
            ...
            sConv2d(3, 16, kernel_size=3, stride=1, padding=1, max_scales=4,
                    usf=True, binarized=False),

            sConv2d(16, 16, kernel_size=3, stride=1, padding=1, max_scales=4,
                    usf=True, binarized=True),

            sConv2d(16, 32, kernel_size=3, stride=1, padding=1, max_scales=4,
                    usf=True, binarized=True),
            ...
            sConv2d(256, 10, kernel_size=3, stride=1, padding=1, max_scales=4,
